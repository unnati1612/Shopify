...
console.log(category)
  ...
  return (
    ...
    <div className='row mt-2'>
      ...
      <div className='d-flex flex-md-column align-items-center flex-row   '>
          {
            item?.images?.map((item)=>(
              <div style={{width:"100px",height:"90px"}} className='mb-2'>
              <img src={item} style={{width:"100%",height:"100%"}} className=''/>
              </div>
            ))
          }
        </div>
     
        <img src={item?.thumbnail} style={{width:"50%",height:"50%"}}/>
